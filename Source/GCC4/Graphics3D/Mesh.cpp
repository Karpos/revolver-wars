...
//
// RevolverMeshNode::RevolverMeshNode					- Chapter X, page Y 
//
D3DRevolverMeshNode9::D3DRevolverMeshNode9(const ActorId actorId, WeakBaseRenderComponentPtr renderComponent, std::string fxFileName, RenderPass renderPass, const Mat4x4 *t)
...
//
// RevolverMeshNode::VOnRestore						- Chapter X, page Y
//
HRESULT D3DRevolverMeshNode9::VOnRestore(Scene *pScene)
{
	HRESULT hr;
	...
	//Rotate the Revolver 90 degrees from default so that the spout faces forward
	Mat4x4 rotateY90;
