//========================================================================
// RevolverEvents.cpp : defines game-specific events for RevolverWars
//
...
// Note: these are game specific events, which really should be in RevolverEvents.cpp.
// They aren't because of an annoying dependancy in Network.cpp, which creates events
// from a bitstream. Once we get "real" streaming code in we can move these back to RevolverEvents.cpp.
...
const EventType EvtData_Destroy_Player::sk_EventType(0x8dd3c586);
...
void RegisterRevolverScriptEvents(void)
{
