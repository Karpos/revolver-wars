#pragma once
//========================================================================
// RevolverEvents.h : defines game-specific events for RevolverWars
//
...
// Nasty game dependent events here. We'll move this back into game specific RevolverEvents.h when real streaming code 
