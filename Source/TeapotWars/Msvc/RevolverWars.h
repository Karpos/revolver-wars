#pragma once
//========================================================================
// RevolverWars.h : source file for the sample game
//
...
//---------------------------------------------------------------------------------------------------------------------
// RevolverWarsApp class                          - Chapter 21, page 722
// Note: Don't put anything in this class that needs to be destructed
//---------------------------------------------------------------------------------------------------------------------
class RevolverWarsApp : public GameCodeApp
{
protected:
	virtual BaseGameLogic *VCreateGameAndView();

public:
	virtual TCHAR *VGetGameTitle() { return _T("Revolver Wars"); }
	virtual TCHAR *VGetGameAppDirectory() { return _T("Game Coding Complete 4\\Revolver Wars\\4.0"); }
...
//---------------------------------------------------------------------------------------------------------------------
// RevolverWarsLogic class                        - Chapter 21, page 723
//---------------------------------------------------------------------------------------------------------------------
class RevolverWarsLogic : public BaseGameLogic
{
protected:
...
public:
	RevolverWarsLogic();
	virtual ~RevolverWarsLogic();

	// RevolverWars Methods
