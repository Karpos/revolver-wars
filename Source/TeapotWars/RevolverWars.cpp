//========================================================================
// RevolverWars.cpp : source file for the sample game
//
...
#include "RevolverWars.h"
#include "RevolverWarsView.h"
#include "RevolverNetwork.h"
#include "RevolverEvents.h"
#include "RevolverResources.h"


RevolverWarsApp g_RevolverWarsApp;
...
//========================================================================
//
// RevolverWarsApp Implementation     - Chapter 21, page 722
//
//========================================================================
...
//
// RevolverWarsApp::VCreateGameAndView
//
BaseGameLogic *RevolverWarsApp::VCreateGameAndView()
{
	m_pGame = GCC_NEW RevolverWarsLogic();
    m_pGame->Init();
...
HICON RevolverWarsApp::VGetIcon()
{
	return LoadIcon(GetInstance(), MAKEINTRESOURCE(IDI_ICON1));
}

void RevolverWarsApp::VRegisterGameEvents(void)
{
...
void RevolverWarsApp::VCreateNetworkEventForwarder(void)
{
...
void RevolverWarsApp::VDestroyNetworkEventForwarder(void)
{
...
//========================================================================
//
// RevolverWarsLogic Implementation       - Chapter 21, page 725
//
//========================================================================

//
// RevolverWarsLogic::RevolverWarsLogic
//
RevolverWarsLogic::RevolverWarsLogic()
{
...
void RevolverWarsLogic::VSetProxy()
{
...
//
// RevolverWarsLogic::VChangeState
//
void RevolverWarsLogic::VChangeState(BaseGameState newState)
{
	...
	switch(newState)
	{
		case BGS_WaitingForPlayers:
		{
			...
			{
				shared_ptr<IGameView> playersView(GCC_NEW RevolverWarsHumanView(g_pApp->m_Renderer));
			...
			{
				shared_ptr<IGameView> aiView(GCC_NEW AIRevolverView(m_pPathingGraph));
				VAddView(aiView);
			}
			break;
		}
		...
		case BGS_SpawningPlayersActors:
		{
			...
			for (auto it = m_gameViews.begin(); it != m_gameViews.end(); ++it)
			{
				...
				{
					shared_ptr<AIRevolverView> pAiView = static_pointer_cast<AIRevolverView, IGameView>(pView);
...
//
// RevolverWarsLogic::VAddView
//
void RevolverWarsLogic::VAddView(shared_ptr<IGameView> pView, ActorId actor)
{
...
//	}
	if (dynamic_pointer_cast<RevolverWarsHumanView>(pView))
	{
		m_HumanPlayersAttached++;
	}
	else if (dynamic_pointer_cast<AIRevolverView>(pView))
	{
		m_AIPlayersAttached++;
	}
}
...
void RevolverWarsLogic::VMoveActor(const ActorId id, Mat4x4 const &mat)
{
...
void RevolverWarsLogic::RequestStartGameDelegate(IEventDataPtr pEventData)
{
	VChangeState(BGS_WaitingForPlayers);
}

void RevolverWarsLogic::EnvironmentLoadedDelegate(IEventDataPtr pEventData)
{
    ++m_HumanGamesLoaded;
}


// FUTURE WORK - this isn't RevolverWars specific so it can go into the game agnostic base class
void RevolverWarsLogic::RemoteClientDelegate(IEventDataPtr pEventData)
{
...
void RevolverWarsLogic::NetworkPlayerActorAssignmentDelegate(IEventDataPtr pEventData)
{
	if (!m_bProxy)
		return;
	...
	for (auto it = m_gameViews.begin(); it != m_gameViews.end(); ++it)
    {
        ...
        if (pView->VGetType() == GameView_Human)
        {
            shared_ptr<RevolverWarsHumanView> pHumanView = static_pointer_cast<RevolverWarsHumanView, IGameView>(pView);
...
void RevolverWarsLogic::StartThrustDelegate(IEventDataPtr pEventData)
{
...
void RevolverWarsLogic::EndThrustDelegate(IEventDataPtr pEventData)
{
    shared_ptr<EvtData_StartThrust> pCastEventData = static_pointer_cast<EvtData_StartThrust>(pEventData);
    StrongActorPtr pActor = MakeStrongPtr(VGetActor(pCastEventData->GetActorId()));
    if (pActor)
...
void RevolverWarsLogic::StartSteerDelegate(IEventDataPtr pEventData)
{
    shared_ptr<EvtData_StartThrust> pCastEventData = static_pointer_cast<EvtData_StartThrust>(pEventData);
    StrongActorPtr pActor = MakeStrongPtr(VGetActor(pCastEventData->GetActorId()));
    if (pActor)
...
void RevolverWarsLogic::EndSteerDelegate(IEventDataPtr pEventData)
{
    shared_ptr<EvtData_StartThrust> pCastEventData = static_pointer_cast<EvtData_StartThrust>(pEventData);
    StrongActorPtr pActor = MakeStrongPtr(VGetActor(pCastEventData->GetActorId()));
    if (pActor)
...
void RevolverWarsLogic::TestScriptDelegate(IEventDataPtr pEventData)
{
...
void RevolverWarsLogic::RegisterAllDelegates(void)
{
	// FUTURE WORK: Lots of these functions are ok to go into the base game logic!
    IEventManager* pGlobalEventManager = IEventManager::Get();
    pGlobalEventManager->VAddListener(MakeDelegate(this, &RevolverWarsLogic::RemoteClientDelegate), EvtData_Remote_Client::sk_EventType);
    pGlobalEventManager->VAddListener(MakeDelegate(this, &RevolverWarsLogic::MoveActorDelegate), EvtData_Move_Actor::sk_EventType);
    pGlobalEventManager->VAddListener(MakeDelegate(this, &RevolverWarsLogic::RequestStartGameDelegate), EvtData_Request_Start_Game::sk_EventType);
    pGlobalEventManager->VAddListener(MakeDelegate(this, &RevolverWarsLogic::NetworkPlayerActorAssignmentDelegate), EvtData_Network_Player_Actor_Assignment::sk_EventType);
	pGlobalEventManager->VAddListener(MakeDelegate(this, &RevolverWarsLogic::EnvironmentLoadedDelegate), EvtData_Environment_Loaded::sk_EventType);
	pGlobalEventManager->VAddListener(MakeDelegate(this, &RevolverWarsLogic::EnvironmentLoadedDelegate), EvtData_Remote_Environment_Loaded::sk_EventType);

	// FUTURE WORK: Only these belong in RevolverWars.
    pGlobalEventManager->VAddListener(MakeDelegate(this, &RevolverWarsLogic::StartThrustDelegate), EvtData_StartThrust::sk_EventType);
    pGlobalEventManager->VAddListener(MakeDelegate(this, &RevolverWarsLogic::EndThrustDelegate), EvtData_EndThrust::sk_EventType);
    pGlobalEventManager->VAddListener(MakeDelegate(this, &RevolverWarsLogic::StartSteerDelegate), EvtData_StartSteer::sk_EventType);
    pGlobalEventManager->VAddListener(MakeDelegate(this, &RevolverWarsLogic::EndSteerDelegate), EvtData_EndSteer::sk_EventType);

    pGlobalEventManager->VAddListener(MakeDelegate(this, &RevolverWarsLogic::TestScriptDelegate), EvtData_ScriptEventTest_FromLua::sk_EventType);
}

void RevolverWarsLogic::RemoveAllDelegates(void)
{
	// FUTURE WORK: See the note in RegisterDelegates above....
    IEventManager* pGlobalEventManager = IEventManager::Get();
    pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RevolverWarsLogic::RemoteClientDelegate), EvtData_Remote_Client::sk_EventType);
    pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RevolverWarsLogic::MoveActorDelegate), EvtData_Move_Actor::sk_EventType);
    pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RevolverWarsLogic::RequestStartGameDelegate), EvtData_Request_Start_Game::sk_EventType);
    pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RevolverWarsLogic::NetworkPlayerActorAssignmentDelegate), EvtData_Network_Player_Actor_Assignment::sk_EventType);
	pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RevolverWarsLogic::EnvironmentLoadedDelegate), EvtData_Environment_Loaded::sk_EventType);
	pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RevolverWarsLogic::EnvironmentLoadedDelegate), EvtData_Remote_Environment_Loaded::sk_EventType);
	if (m_bProxy)
	{
	    pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RevolverWarsLogic::RequestNewActorDelegate), EvtData_Request_New_Actor::sk_EventType);
	}

	// FUTURE WORK: These belong in Revolver wars!
	pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RevolverWarsLogic::StartThrustDelegate), EvtData_StartThrust::sk_EventType);
    pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RevolverWarsLogic::EndThrustDelegate), EvtData_EndThrust::sk_EventType);
    pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RevolverWarsLogic::StartSteerDelegate), EvtData_StartSteer::sk_EventType);
    pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RevolverWarsLogic::EndSteerDelegate), EvtData_EndSteer::sk_EventType);

    pGlobalEventManager->VRemoveListener(MakeDelegate(this, &RevolverWarsLogic::TestScriptDelegate), EvtData_ScriptEventTest_FromLua::sk_EventType);
}

void RevolverWarsLogic::CreateNetworkEventForwarder(const int socketId)
{
...
void RevolverWarsLogic::DestroyAllNetworkEventForwarders(void)
{
...
bool RevolverWarsLogic::VLoadGameDelegate(TiXmlElement* pLevelData)
{
    RegisterRevolverScriptEvents();
    return true;
}
