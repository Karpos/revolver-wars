// RevolverController.cpp - Controller class for the player Revolvers
//
...
////////////////////////////////////////////////////
// RevolverController Implementation
////////////////////////////////////////////////////


//
// RevolverController::RevolverController			- Chapter 19, page 735
//
RevolverController::RevolverController(shared_ptr<SceneNode> object)
: m_object(object)
{
...
//
// RevolverController::VOnLButtonDown				- Chapter 19, page 735
//
bool RevolverController::VOnPointerButtonDown(const Point &mousePos, const int radius, const std::string &buttonName)
{
	if (buttonName != "PointerLeft")
		return false;
	ActorId actorId = m_object->VGet()->ActorId();
	GCC_ASSERT(actorId != INVALID_ACTOR_ID && _T("The Revolver controller isn't attached to a valid actor!"));
...
//
// RevolverController::OnUpdate				- Chapter 19, page 736
//
void RevolverController::OnUpdate(DWORD const deltaMilliseconds)  
{
    //
}

bool RevolverController::VOnKeyDown(const BYTE c)
{
...
bool RevolverController::VOnKeyUp(const BYTE c)
{
    // update the key table
    m_bKey[c] = false;
