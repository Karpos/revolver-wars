...
function OnDestroyPlayer(eventData)
	g_actorMgr:OnDestroyPlayer(eventData);
end
...
function RegisterListeners()
	...
	if (EventType.EvtData_Destroy_Player ~= nil) then
		RegisterEventListener(EventType.EvtData_Destroy_Player, OnDestroyPlayer);
	end
end
